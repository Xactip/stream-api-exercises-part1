...
public class InMemoryWorldDao implements WorldDao {
    ...
    public void createCountries() {
        countries.put("ABW", new Country("ABW", "Aruba", "North America", 103000, 193.00, 828.00, 129, null));
        countries.put("AFG", new Country("AFG", "Afghanistan", "Asia", 22720000, 652090.00, 5976.00, 1, null));
        countries.put("AGO", new Country("AGO", "Angola", "Africa", 12878000, 1246700.00, 6648.00, 56, null));
        countries.put("AIA", new Country("AIA", "Anguilla", "North America", 8000, 96.00, 63.20, 62, null));
        countries.put("ALB", new Country("ALB", "Albania", "Europe", 3401200, 28748.00, 3205.00, 34, null));
        countries.put("AND", new Country("AND", "Andorra", "Europe", 78000, 468.00, 1630.00, 55, null));
        countries.put("ANT", new Country("ANT", "Netherlands Antilles", "North America", 217000, 800.00, 1941.00, 33, null));
        countries.put("ARE", new Country("ARE", "United Arab Emirates", "Asia", 2441000, 83600.00, 37966.00, 65, null));
        countries.put("ARG", new Country("ARG", "Argentina", "South America", 37032000, 2780400.00, 340238.00, 69, null));
        countries.put("ARM", new Country("ARM", "Armenia", "Asia", 3520000, 29800.00, 1813.00, 126, null));
        countries.put("ASM", new Country("ASM", "American Samoa", "Oceania", 68000, 199.00, 334.00, 54, null));
        countries.put("ATA", new Country("ATA", "Antarctica", "Antarctica", 0, 13120000.00, 0.00, -1, null));
        countries.put("ATF", new Country("ATF", "French Southern territories", "Antarctica", 0, 7780.00, 0.00, -1, null));
        countries.put("ATG", new Country("ATG", "Antigua and Barbuda", "North America", 68000, 442.00, 612.00, 63, null));
        countries.put("AUS", new Country("AUS", "Australia", "Oceania", 18886000, 7741220.00, 351182.00, 135, null));
        countries.put("AUT", new Country("AUT", "Austria", "Europe", 8091800, 83859.00, 211860.00, 1523, null));
        countries.put("AZE", new Country("AZE", "Azerbaijan", "Asia", 7734000, 86600.00, 4127.00, 144, null));
        countries.put("BDI", new Country("BDI", "Burundi", "Africa", 6695000, 27834.00, 903.00, 552, null));
        countries.put("BEL", new Country("BEL", "Belgium", "Europe", 10239000, 30518.00, 249704.00, 179, null));
        countries.put("BEN", new Country("BEN", "Benin", "Africa", 6097000, 112622.00, 2357.00, 187, null));
        countries.put("BFA", new Country("BFA", "Burkina Faso", "Africa", 11937000, 274000.00, 2425.00, 549, null));
        countries.put("BGD", new Country("BGD", "Bangladesh", "Asia", 129155000, 143998.00, 32852.00, 150, null));
        countries.put("BGR", new Country("BGR", "Bulgaria", "Europe", 8190900, 110994.00, 12178.00, 539, null));
        countries.put("BHR", new Country("BHR", "Bahrain", "Asia", 617000, 694.00, 6366.00, 149, null));
        countries.put("BHS", new Country("BHS", "Bahamas", "North America", 307000, 13878.00, 3527.00, 148, null));
        countries.put("BIH", new Country("BIH", "Bosnia and Herzegovina", "Europe", 3972000, 51197.00, 2841.00, 201, null));
        countries.put("BLR", new Country("BLR", "Belarus", "Europe", 10236000, 207600.00, 13714.00, 3520, null));
        countries.put("BLZ", new Country("BLZ", "Belize", "North America", 241000, 22696.00, 630.00, 185, null));
        countries.put("BMU", new Country("BMU", "Bermuda", "North America", 65000, 53.00, 2328.00, 191, null));
        countries.put("BOL", new Country("BOL", "Bolivia", "South America", 8329000, 1098581.00, 8571.00, 194, null));
        countries.put("BRA", new Country("BRA", "Brazil", "South America", 170115000, 8547403.00, 776739.00, 211, null));
        countries.put("BRB", new Country("BRB", "Barbados", "North America", 270000, 430.00, 2223.00, 174, null));
        countries.put("BRN", new Country("BRN", "Brunei", "Asia", 328000, 5765.00, 11705.00, 538, null));
        countries.put("BTN", new Country("BTN", "Bhutan", "Asia", 2124000, 47000.00, 372.00, 192, null));
        countries.put("BVT", new Country("BVT", "Bouvet Island", "Antarctica", 0, 59.00, 0.00, -1, null));
        countries.put("BWA", new Country("BWA", "Botswana", "Africa", 1622000, 581730.00, 4834.00, 204, null));
        countries.put("CAF", new Country("CAF", "Central African Republic", "Africa", 3615000, 622984.00, 1054.00, 1889, null));
        countries.put("CAN", new Country("CAN", "Canada", "North America", 31147000, 9970610.00, 598862.00, 1822, null));
        countries.put("CCK", new Country("CCK", "Cocos (Keeling) Islands", "Oceania", 600, 14.00, 0.00, 2317, null));
        countries.put("CHE", new Country("CHE", "Switzerland", "Europe", 7160400, 41284.00, 264478.00, 3248, null));
        countries.put("CHL", new Country("CHL", "Chile", "South America", 15211000, 756626.00, 72949.00, 554, null));
        countries.put("CHN", new Country("CHN", "China", "Asia", 1277558000, 9572900.00, 982268.00, 1891, null));
        countries.put("CIV", new Country("CIV", "Câ€œte d?Ivoire", "Africa", 14786000, 322463.00, 11345.00, 2814, null));
        countries.put("CMR", new Country("CMR", "Cameroon", "Africa", 15085000, 475442.00, 9174.00, 1804, null));
        countries.put("COD", new Country("COD", "Congo, The Democratic Republic of the", "Africa", 51654000, 2344858.00, 6964.00, 2298, null));
        countries.put("COG", new Country("COG", "Congo", "Africa", 2943000, 342000.00, 2108.00, 2296, null));
        countries.put("COK", new Country("COK", "Cook Islands", "Oceania", 20000, 236.00, 100.00, 583, null));
        countries.put("COL", new Country("COL", "Colombia", "South America", 42321000, 1138914.00, 102896.00, 2257, null));
        countries.put("COM", new Country("COM", "Comoros", "Africa", 578000, 1862.00, 4401.00, 2295, null));
        countries.put("CPV", new Country("CPV", "Cape Verde", "Africa", 428000, 4033.00, 435.00, 1859, null));
        countries.put("CRI", new Country("CRI", "Costa Rica", "North America", 4023000, 51100.00, 10226.00, 584, null));
        countries.put("CUB", new Country("CUB", "Cuba", "North America", 11201000, 110861.00, 17843.00, 2413, null));
        countries.put("CXR", new Country("CXR", "Christmas Island", "Oceania", 2500, 135.00, 0.00, 1791, null));
        countries.put("CYM", new Country("CYM", "Cayman Islands", "North America", 38000, 264.00, 1263.00, 553, null));
        countries.put("CYP", new Country("CYP", "Cyprus", "Asia", 754700, 9251.00, 9333.00, 2430, null));
        countries.put("CZE", new Country("CZE", "Czech Republic", "Europe", 10278100, 78866.00, 55017.00, 3339, null));
        countries.put("DEU", new Country("DEU", "Germany", "Europe", 82164700, 357022.00, 2133367.00, 3068, null));
        countries.put("DJI", new Country("DJI", "Djibouti", "Africa", 638000, 23200.00, 382.00, 585, null));
        countries.put("DMA", new Country("DMA", "Dominica", "North America", 71000, 751.00, 256.00, 586, null));
        countries.put("DNK", new Country("DNK", "Denmark", "Europe", 5330000, 43094.00, 174099.00, 3315, null));
        countries.put("DOM", new Country("DOM", "Dominican Republic", "North America", 8495000, 48511.00, 15846.00, 587, null));
        countries.put("DZA", new Country("DZA", "Algeria", "Africa", 31471000, 2381741.00, 49982.00, 35, null));
        countries.put("ECU", new Country("ECU", "Ecuador", "South America", 12646000, 283561.00, 19770.00, 594, null));
        countries.put("EGY", new Country("EGY", "Egypt", "Africa", 68470000, 1001449.00, 82710.00, 608, null));
        countries.put("ERI", new Country("ERI", "Eritrea", "Africa", 3850000, 117600.00, 650.00, 652, null));
        countries.put("ESH", new Country("ESH", "Western Sahara", "Africa", 293000, 266000.00, 60.00, 2453, null));
        countries.put("ESP", new Country("ESP", "Spain", "Europe", 39441700, 505992.00, 553233.00, 653, null));
        countries.put("EST", new Country("EST", "Estonia", "Europe", 1439200, 45227.00, 5328.00, 3791, null));
        countries.put("ETH", new Country("ETH", "Ethiopia", "Africa", 62565000, 1104300.00, 6353.00, 756, null));
        countries.put("FIN", new Country("FIN", "Finland", "Europe", 5171300, 338145.00, 121914.00, 3236, null));
        countries.put("FJI", new Country("FJI", "Fiji Islands", "Oceania", 817000, 18274.00, 1536.00, 764, null));
        countries.put("FLK", new Country("FLK", "Falkland Islands", "South America", 2000, 12173.00, 0.00, 763, null));
        countries.put("FRA", new Country("FRA", "France", "Europe", 59225700, 551500.00, 1424285.00, 2974, null));
        countries.put("FRO", new Country("FRO", "Faroe Islands", "Europe", 43000, 1399.00, 0.00, 901, null));
        countries.put("FSM", new Country("FSM", "Micronesia, Federated States of", "Oceania", 119000, 702.00, 212.00, 2689, null));
        countries.put("GAB", new Country("GAB", "Gabon", "Africa", 1226000, 267668.00, 5493.00, 902, null));
        countries.put("GBR", new Country("GBR", "United Kingdom", "Europe", 59623400, 242900.00, 1378330.00, 456, null));
        countries.put("GEO", new Country("GEO", "Georgia", "Asia", 4968000, 69700.00, 6064.00, 905, null));
        countries.put("GHA", new Country("GHA", "Ghana", "Africa", 20212000, 238533.00, 7137.00, 910, null));
        countries.put("GIB", new Country("GIB", "Gibraltar", "Europe", 25000, 6.00, 258.00, 915, null));
        countries.put("GIN", new Country("GIN", "Guinea", "Africa", 7430000, 245857.00, 2352.00, 926, null));
        countries.put("GLP", new Country("GLP", "Guadeloupe", "North America", 456000, 1705.00, 3501.00, 919, null));
        countries.put("GMB", new Country("GMB", "Gambia", "Africa", 1305000, 11295.00, 320.00, 904, null));
        countries.put("GNB", new Country("GNB", "Guinea-Bissau", "Africa", 1213000, 36125.00, 293.00, 927, null));
        countries.put("GNQ", new Country("GNQ", "Equatorial Guinea", "Africa", 453000, 28051.00, 283.00, 2972, null));
        countries.put("GRC", new Country("GRC", "Greece", "Europe", 10545700, 131626.00, 120724.00, 2401, null));
        countries.put("GRD", new Country("GRD", "Grenada", "North America", 94000, 344.00, 318.00, 916, null));
        countries.put("GRL", new Country("GRL", "Greenland", "North America", 56000, 2166090.00, 0.00, 917, null));
        countries.put("GTM", new Country("GTM", "Guatemala", "North America", 11385000, 108889.00, 19008.00, 922, null));
        countries.put("GUF", new Country("GUF", "French Guiana", "South America", 181000, 90000.00, 681.00, 3014, null));
        countries.put("GUM", new Country("GUM", "Guam", "Oceania", 168000, 549.00, 1197.00, 921, null));
        countries.put("GUY", new Country("GUY", "Guyana", "South America", 861000, 214969.00, 722.00, 928, null));
        countries.put("HKG", new Country("HKG", "Hong Kong", "Asia", 6782000, 1075.00, 166448.00, 937, null));
        countries.put("HMD", new Country("HMD", "Heard Island and McDonald Islands", "Antarctica", 0, 359.00, 0.00, -1, null));
        countries.put("HND", new Country("HND", "Honduras", "North America", 6485000, 112088.00, 5333.00, 933, null));
        countries.put("HRV", new Country("HRV", "Croatia", "Europe", 4473000, 56538.00, 20208.00, 2409, null));
        countries.put("HTI", new Country("HTI", "Haiti", "North America", 8222000, 27750.00, 3459.00, 929, null));
        countries.put("HUN", new Country("HUN", "Hungary", "Europe", 10043200, 93030.00, 48267.00, 3483, null));
        countries.put("IDN", new Country("IDN", "Indonesia", "Asia", 212107000, 1904569.00, 84982.00, 939, null));
        countries.put("IND", new Country("IND", "India", "Asia", 1013662000, 3287263.00, 447114.00, 1109, null));
        countries.put("IOT", new Country("IOT", "British Indian Ocean Territory", "Africa", 0, 78.00, 0.00, -1, null));
        countries.put("IRL", new Country("IRL", "Ireland", "Europe", 3775100, 70273.00, 75921.00, 1447, null));
        countries.put("IRN", new Country("IRN", "Iran", "Asia", 67702000, 1648195.00, 195746.00, 1380, null));
        countries.put("IRQ", new Country("IRQ", "Iraq", "Asia", 23115000, 438317.00, 11500.00, 1365, null));
        countries.put("ISL", new Country("ISL", "Iceland", "Europe", 279000, 103000.00, 8255.00, 1449, null));
        countries.put("ISR", new Country("ISR", "Israel", "Asia", 6217000, 21056.00, 97477.00, 1450, null));
        countries.put("ITA", new Country("ITA", "Italy", "Europe", 57680000, 301316.00, 1161755.00, 1464, null));
        countries.put("JAM", new Country("JAM", "Jamaica", "North America", 2583000, 10990.00, 6871.00, 1530, null));
        countries.put("JOR", new Country("JOR", "Jordan", "Asia", 5083000, 88946.00, 7526.00, 1786, null));
        countries.put("JPN", new Country("JPN", "Japan", "Asia", 126714000, 377829.00, 3787042.00, 1532, null));
        countries.put("KAZ", new Country("KAZ", "Kazakstan", "Asia", 16223000, 2724900.00, 24375.00, 1864, null));
        countries.put("KEN", new Country("KEN", "Kenya", "Africa", 30080000, 580367.00, 9217.00, 1881, null));
        countries.put("KGZ", new Country("KGZ", "Kyrgyzstan", "Asia", 4699000, 199900.00, 1626.00, 2253, null));
        countries.put("KHM", new Country("KHM", "Cambodia", "Asia", 11168000, 181035.00, 5121.00, 1800, null));
        countries.put("KIR", new Country("KIR", "Kiribati", "Oceania", 83000, 726.00, 40.70, 2256, null));
        countries.put("KNA", new Country("KNA", "Saint Kitts and Nevis", "North America", 38000, 261.00, 299.00, 3064, null));
        countries.put("KOR", new Country("KOR", "South Korea", "Asia", 46844000, 99434.00, 320749.00, 2331, null));
        countries.put("KWT", new Country("KWT", "Kuwait", "Asia", 1972000, 17818.00, 27037.00, 2429, null));
        countries.put("LAO", new Country("LAO", "Laos", "Asia", 5433000, 236800.00, 1292.00, 2432, null));
        countries.put("LBN", new Country("LBN", "Lebanon", "Asia", 3282000, 10400.00, 17121.00, 2438, null));
        countries.put("LBR", new Country("LBR", "Liberia", "Africa", 3154000, 111369.00, 2012.00, 2440, null));
        countries.put("LBY", new Country("LBY", "Libyan Arab Jamahiriya", "Africa", 5605000, 1759540.00, 44806.00, 2441, null));
        countries.put("LCA", new Country("LCA", "Saint Lucia", "North America", 154000, 622.00, 571.00, 3065, null));
        countries.put("LIE", new Country("LIE", "Liechtenstein", "Europe", 32300, 160.00, 1119.00, 2446, null));
        countries.put("LKA", new Country("LKA", "Sri Lanka", "Asia", 18827000, 65610.00, 15706.00, 3217, null));
        countries.put("LSO", new Country("LSO", "Lesotho", "Africa", 2153000, 30355.00, 1061.00, 2437, null));
        countries.put("LTU", new Country("LTU", "Lithuania", "Europe", 3698500, 65301.00, 10692.00, 2447, null));
        countries.put("LUX", new Country("LUX", "Luxembourg", "Europe", 435700, 2586.00, 16321.00, 2452, null));
        countries.put("LVA", new Country("LVA", "Latvia", "Europe", 2424200, 64589.00, 6398.00, 2434, null));
        countries.put("MAC", new Country("MAC", "Macao", "Asia", 473000, 18.00, 5749.00, 2454, null));
        countries.put("MAR", new Country("MAR", "Morocco", "Africa", 28351000, 446550.00, 36124.00, 2486, null));
        countries.put("MCO", new Country("MCO", "Monaco", "Europe", 34000, 1.50, 776.00, 2695, null));
        countries.put("MDA", new Country("MDA", "Moldova", "Europe", 4380000, 33851.00, 1579.00, 2690, null));
        countries.put("MDG", new Country("MDG", "Madagascar", "Africa", 15942000, 587041.00, 3750.00, 2455, null));
        countries.put("MDV", new Country("MDV", "Maldives", "Asia", 286000, 298.00, 199.00, 2463, null));
        countries.put("MEX", new Country("MEX", "Mexico", "North America", 98881000, 1958201.00, 414972.00, 2515, null));
        countries.put("MHL", new Country("MHL", "Marshall Islands", "Oceania", 64000, 181.00, 97.00, 2507, null));
        countries.put("MKD", new Country("MKD", "Macedonia", "Europe", 2024000, 25713.00, 1694.00, 2460, null));
        countries.put("MLI", new Country("MLI", "Mali", "Africa", 11234000, 1240192.00, 2642.00, 2482, null));
        countries.put("MLT", new Country("MLT", "Malta", "Europe", 380200, 316.00, 3512.00, 2484, null));
        countries.put("MMR", new Country("MMR", "Myanmar", "Asia", 45611000, 676578.00, 180375.00, 2710, null));
        countries.put("MNG", new Country("MNG", "Mongolia", "Asia", 2662000, 1566500.00, 1043.00, 2696, null));
        countries.put("MNP", new Country("MNP", "Northern Mariana Islands", "Oceania", 78000, 464.00, 0.00, 2913, null));
        countries.put("MOZ", new Country("MOZ", "Mozambique", "Africa", 19680000, 801590.00, 2891.00, 2698, null));
        countries.put("MRT", new Country("MRT", "Mauritania", "Africa", 2670000, 1025520.00, 998.00, 2509, null));
        countries.put("MSR", new Country("MSR", "Montserrat", "North America", 11000, 102.00, 109.00, 2697, null));
        countries.put("MTQ", new Country("MTQ", "Martinique", "North America", 395000, 1102.00, 2731.00, 2508, null));
        countries.put("MUS", new Country("MUS", "Mauritius", "Africa", 1158000, 2040.00, 4251.00, 2511, null));
        countries.put("MWI", new Country("MWI", "Malawi", "Africa", 10925000, 118484.00, 1687.00, 2462, null));
        countries.put("MYS", new Country("MYS", "Malaysia", "Asia", 22244000, 329758.00, 69213.00, 2464, null));
        countries.put("MYT", new Country("MYT", "Mayotte", "Africa", 149000, 373.00, 0.00, 2514, null));
        countries.put("NAM", new Country("NAM", "Namibia", "Africa", 1726000, 824292.00, 3101.00, 2726, null));
        countries.put("NCL", new Country("NCL", "New Caledonia", "Oceania", 214000, 18575.00, 3563.00, 3493, null));
        countries.put("NER", new Country("NER", "Niger", "Africa", 10730000, 1267000.00, 1706.00, 2738, null));
        countries.put("NFK", new Country("NFK", "Norfolk Island", "Oceania", 2000, 36.00, 0.00, 2806, null));
        countries.put("NGA", new Country("NGA", "Nigeria", "Africa", 111506000, 923768.00, 65707.00, 2754, null));
        countries.put("NIC", new Country("NIC", "Nicaragua", "North America", 5074000, 130000.00, 1988.00, 2734, null));
        countries.put("NIU", new Country("NIU", "Niue", "Oceania", 2000, 260.00, 0.00, 2805, null));
        countries.put("NLD", new Country("NLD", "Netherlands", "Europe", 15864000, 41526.00, 371362.00, 5, null));
        countries.put("NOR", new Country("NOR", "Norway", "Europe", 4478500, 323877.00, 145895.00, 2807, null));
        countries.put("NPL", new Country("NPL", "Nepal", "Asia", 23930000, 147181.00, 4768.00, 2729, null));
        countries.put("NRU", new Country("NRU", "Nauru", "Oceania", 12000, 21.00, 197.00, 2728, null));
        countries.put("NZL", new Country("NZL", "New Zealand", "Oceania", 3862000, 270534.00, 54669.00, 3499, null));
        countries.put("OMN", new Country("OMN", "Oman", "Asia", 2542000, 309500.00, 16904.00, 2821, null));
        countries.put("PAK", new Country("PAK", "Pakistan", "Asia", 156483000, 796095.00, 61289.00, 2831, null));
        countries.put("PAN", new Country("PAN", "Panama", "North America", 2856000, 75517.00, 9131.00, 2882, null));
        countries.put("PCN", new Country("PCN", "Pitcairn", "Oceania", 50, 49.00, 0.00, 2912, null));
        countries.put("PER", new Country("PER", "Peru", "South America", 25662000, 1285216.00, 64140.00, 2890, null));
        countries.put("PHL", new Country("PHL", "Philippines", "Asia", 75967000, 300000.00, 65107.00, 766, null));
        countries.put("PLW", new Country("PLW", "Palau", "Oceania", 19000, 459.00, 105.00, 2881, null));
        countries.put("PNG", new Country("PNG", "Papua New Guinea", "Oceania", 4807000, 462840.00, 4988.00, 2884, null));
        countries.put("POL", new Country("POL", "Poland", "Europe", 38653600, 323250.00, 151697.00, 2928, null));
        countries.put("PRI", new Country("PRI", "Puerto Rico", "North America", 3869000, 8875.00, 34100.00, 2919, null));
        countries.put("PRK", new Country("PRK", "North Korea", "Asia", 24039000, 120538.00, 5332.00, 2318, null));
        countries.put("PRT", new Country("PRT", "Portugal", "Europe", 9997600, 91982.00, 105954.00, 2914, null));
        countries.put("PRY", new Country("PRY", "Paraguay", "South America", 5496000, 406752.00, 8444.00, 2885, null));
        countries.put("PSE", new Country("PSE", "Palestine", "Asia", 3101000, 6257.00, 4173.00, 4074, null));
        countries.put("PYF", new Country("PYF", "French Polynesia", "Oceania", 235000, 4000.00, 818.00, 3016, null));
        countries.put("QAT", new Country("QAT", "Qatar", "Asia", 599000, 11000.00, 9472.00, 2973, null));
        countries.put("REU", new Country("REU", "Râ€šunion", "Africa", 699000, 2510.00, 8287.00, 3017, null));
        countries.put("ROM", new Country("ROM", "Romania", "Europe", 22455500, 238391.00, 38158.00, 3018, null));
        countries.put("RUS", new Country("RUS", "Russian Federation", "Europe", 146934000, 17075400.00, 276608.00, 3580, null));
        countries.put("RWA", new Country("RWA", "Rwanda", "Africa", 7733000, 26338.00, 2036.00, 3047, null));
        countries.put("SAU", new Country("SAU", "Saudi Arabia", "Asia", 21607000, 2149690.00, 137635.00, 3173, null));
        countries.put("SDN", new Country("SDN", "Sudan", "Africa", 29490000, 2505813.00, 10162.00, 3225, null));
        countries.put("SEN", new Country("SEN", "Senegal", "Africa", 9481000, 196722.00, 4787.00, 3198, null));
        countries.put("SGP", new Country("SGP", "Singapore", "Asia", 3567000, 618.00, 86503.00, 3208, null));
        countries.put("SGS", new Country("SGS", "South Georgia and the South Sandwich Islands", "Antarctica", 0, 3903.00, 0.00, -1, null));
        countries.put("SHN", new Country("SHN", "Saint Helena", "Africa", 6000, 314.00, 0.00, 3063, null));
        countries.put("SJM", new Country("SJM", "Svalbard and Jan Mayen", "Europe", 3200, 62422.00, 0.00, 938, null));
        countries.put("SLB", new Country("SLB", "Solomon Islands", "Oceania", 444000, 28896.00, 182.00, 3161, null));
        countries.put("SLE", new Country("SLE", "Sierra Leone", "Africa", 4854000, 71740.00, 746.00, 3207, null));
        countries.put("SLV", new Country("SLV", "El Salvador", "North America", 6276000, 21041.00, 11863.00, 645, null));
        countries.put("SMR", new Country("SMR", "San Marino", "Europe", 27000, 61.00, 510.00, 3171, null));
        countries.put("SOM", new Country("SOM", "Somalia", "Africa", 10097000, 637657.00, 935.00, 3214, null));
        countries.put("SPM", new Country("SPM", "Saint Pierre and Miquelon", "North America", 7000, 242.00, 0.00, 3067, null));
        countries.put("STP", new Country("STP", "Sao Tome and Principe", "Africa", 147000, 964.00, 6.00, 3172, null));
        countries.put("SUR", new Country("SUR", "Suriname", "South America", 417000, 163265.00, 870.00, 3243, null));
        countries.put("SVK", new Country("SVK", "Slovakia", "Europe", 5398700, 49012.00, 20594.00, 3209, null));
        countries.put("SVN", new Country("SVN", "Slovenia", "Europe", 1987800, 20256.00, 19756.00, 3212, null));
        countries.put("SWE", new Country("SWE", "Sweden", "Europe", 8861400, 449964.00, 226492.00, 3048, null));
        countries.put("SWZ", new Country("SWZ", "Swaziland", "Africa", 1008000, 17364.00, 1206.00, 3244, null));
        countries.put("SYC", new Country("SYC", "Seychelles", "Africa", 77000, 455.00, 536.00, 3206, null));
        countries.put("SYR", new Country("SYR", "Syria", "Asia", 16125000, 185180.00, 65984.00, 3250, null));
        countries.put("TCA", new Country("TCA", "Turks and Caicos Islands", "North America", 17000, 430.00, 96.00, 3423, null));
        countries.put("TCD", new Country("TCD", "Chad", "Africa", 7651000, 1284000.00, 1208.00, 3337, null));
        countries.put("TGO", new Country("TGO", "Togo", "Africa", 4629000, 56785.00, 1449.00, 3332, null));
        countries.put("THA", new Country("THA", "Thailand", "Asia", 61399000, 513115.00, 116416.00, 3320, null));
        countries.put("TJK", new Country("TJK", "Tajikistan", "Asia", 6188000, 143100.00, 1990.00, 3261, null));
        countries.put("TKL", new Country("TKL", "Tokelau", "Oceania", 2000, 12.00, 0.00, 3333, null));
        countries.put("TKM", new Country("TKM", "Turkmenistan", "Asia", 4459000, 488100.00, 4397.00, 3419, null));
        countries.put("TMP", new Country("TMP", "East Timor", "Asia", 885000, 14874.00, 0.00, 1522, null));
        countries.put("TON", new Country("TON", "Tonga", "Oceania", 99000, 650.00, 146.00, 3334, null));
        countries.put("TTO", new Country("TTO", "Trinidad and Tobago", "North America", 1295000, 5130.00, 6232.00, 3336, null));
        countries.put("TUN", new Country("TUN", "Tunisia", "Africa", 9586000, 163610.00, 20026.00, 3349, null));
        countries.put("TUR", new Country("TUR", "Turkey", "Asia", 66591000, 774815.00, 210721.00, 3358, null));
        countries.put("TUV", new Country("TUV", "Tuvalu", "Oceania", 12000, 26.00, 6.00, 3424, null));
        countries.put("TWN", new Country("TWN", "Taiwan", "Asia", 22256000, 36188.00, 256254.00, 3263, null));
        countries.put("TZA", new Country("TZA", "Tanzania", "Africa", 33517000, 883749.00, 8005.00, 3306, null));
        countries.put("UGA", new Country("UGA", "Uganda", "Africa", 21778000, 241038.00, 6313.00, 3425, null));
        countries.put("UKR", new Country("UKR", "Ukraine", "Europe", 50456000, 603700.00, 42168.00, 3426, null));
        countries.put("UMI", new Country("UMI", "United States Minor Outlying Islands", "Oceania", 0, 16.00, 0.00, -1, null));
        countries.put("URY", new Country("URY", "Uruguay", "South America", 3337000, 175016.00, 20831.00, 3492, null));
        countries.put("USA", new Country("USA", "United States", "North America", 278357000, 9363520.00, 8510700.00, 3813, null));
        countries.put("UZB", new Country("UZB", "Uzbekistan", "Asia", 24318000, 447400.00, 14194.00, 3503, null));
        countries.put("VAT", new Country("VAT", "Holy See (Vatican City State)", "Europe", 1000, 0.40, 9.00, 3538, null));
        countries.put("VCT", new Country("VCT", "Saint Vincent and the Grenadines", "North America", 114000, 388.00, 285.00, 3066, null));
        countries.put("VEN", new Country("VEN", "Venezuela", "South America", 24170000, 912050.00, 95023.00, 3539, null));
        countries.put("VGB", new Country("VGB", "Virgin Islands, British", "North America", 21000, 151.00, 612.00, 537, null));
        countries.put("VIR", new Country("VIR", "Virgin Islands, U.S.", "North America", 93000, 347.00, 0.00, 4067, null));
        countries.put("VNM", new Country("VNM", "Vietnam", "Asia", 79832000, 331689.00, 21929.00, 3770, null));
        countries.put("VUT", new Country("VUT", "Vanuatu", "Oceania", 190000, 12189.00, 261.00, 3537, null));
        countries.put("WLF", new Country("WLF", "Wallis and Futuna", "Oceania", 15000, 200.00, 0.00, 3536, null));
        countries.put("WSM", new Country("WSM", "Samoa", "Oceania", 180000, 2831.00, 141.00, 3169, null));
        countries.put("YEM", new Country("YEM", "Yemen", "Asia", 18112000, 527968.00, 6041.00, 1780, null));
        countries.put("YUG", new Country("YUG", "Yugoslavia", "Europe", 10640000, 102173.00, 17000.00, 1792, null));
        countries.put("ZAF", new Country("ZAF", "South Africa", "Africa", 40377000, 1221037.00, 116729.00, 716, null));
        countries.put("ZMB", new Country("ZMB", "Zambia", "Africa", 9169000, 752618.00, 3377.00, 3162, null));
        countries.put("ZWE", new Country("ZWE", "Zimbabwe", "Africa", 11669000, 390757.00, 5951.00, 4068, null));
    }
    ...
    public static InMemoryWorldDao getInstance() {
        synchronized (InMemoryWorldDao.class) {
            if (instance == null) instance = new InMemoryWorldDao();
        }
        return instance;
    }
    ...
    private InMemoryWorldDao() {
        ...
        for (City city : cities.values()) {
            Country country = countries.get(city.countryCode());
            if (country == null) {
                System.out.println("No such countryCode: " + city.countryCode());
                continue;
            }
    ...
    public Country removeCountry(Country country) {
        return countries.remove(country.code());
    }

    @Override
    public Country addCountry(Country country) {
        continents.add(country.continent());
        return countries.put(country.code(), country);
    }

    @Override
    public Country updateCountry(Country country) {
        if (countries.get(country.code()) != null) return countries.put(country.code(), country);
        return null;
    }
    ...
    public List<Country> findCountriesByContinent(String continent) {
        ...
        for (Country country : countries.values())
            if (continent.equals(country.continent())) result.add(country);
        return result;
    }
    ...
    public City removeCity(City city) {
        return cities.remove(city.id());
    }

    @Override
    public City addCity(City city) {
        if (!cities.containsKey(city.id())) return cities.put(city.id(), city);
        return null;
    }
    ...
    public List<City> findCitiesByCountryCode(String countryCode) {
        return findCountryByCode(countryCode).cities();
    }
}
